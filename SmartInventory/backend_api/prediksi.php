...
$total_masuk = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as total FROM transactions WHERE type='masuk'"))['total'];
$total_keluar = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as total FROM transactions WHERE type='keluar'"))['total'];
...
$p_aman_prior = $total_masuk / $total_transaksi;
$p_restock_prior = $total_keluar / $total_transaksi;
